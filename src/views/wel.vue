        ...
        <basic-container>
          <el-collapse v-model="logActiveNames" @change="handleChange">
            <el-collapse-item title="2.7.1发布 增加行政区划管理，支持seata1.2" name="18">
              ...
              <div>3.升级至 FastJson 1.2.70</div>
              <div>4.升级至 Avue 2.5.3</div>
              <div>5.新增行政区划管理模块</div>
              <div>6.优化用户导入的密码配置逻辑</div>
              <div>7.优化INode结构支持懒加载数据格式</div>
              <div>8.优化代码生成模板，支持最新版Saber结构</div>
              <div>9.修复Log模块在多线程、异步场景下报错的问题</div>
            </el-collapse-item>
